                ...
                <div class="wrap-product-detail">
                    <div class="detail-media">
                        <div class="product-gallery">
                            <ul class="slides">
                                ...
                                <li data-thumb="/storage/{{ $p->image }}">
                                    <img src="/storage/{{ $product->image }}" height="800" width="800" alt="product thumbnail" />
                                </li>
                                @endforeach
                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-social">
                            <a class="link-socail" href="#"><img src="{{ asset('ui/frontendTheme/assets/images/social-list.png') }}" alt=""></a>
                        </div>
                        ...
                        <div class="tab-contents">
                            ...
                            <div class="tab-content-item " id="review">
                                ...
                                <div class="wrap-review-form">
                                    ...
                                    <div id="comments">
                                        <h2 class="woocommerce-Reviews-title">01 review for <span>{{ $product->title }}</span></h2>
                        ...
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{ url('product/details/'.$product->id) }}" title="{{ $product->title }}">
                                        <figure><img src="/storage/{{ $product->image }}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                    </a>
